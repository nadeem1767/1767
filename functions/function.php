...
$get_cat_products = "SELECT * FROM `products` WHERE product_cat='$cat_id'";
$run_cat_products = mysqli_query($connection, $get_cat_products);

$count = mysqli_num_rows($run_cat_products);

if ($count==0) {

  echo "<div class='alert alert-danger alert-dismissible fade show' style='background:#003366; color:white;'>
  ...
  $product_brand = $row_cat_products['product_brand'];
      $product_status = $row_cat_products['product_status'];
      
      $product_price = $row_cat_products['product_price'];
      $product_img1 = $row_cat_products['product_img1'];
      $product_img2 = $row_cat_products['product_img2'];
...
$get_brand_products = "SELECT * FROM `products` WHERE product_brand='$brand_id'";
...
if ($count==0) {
  ...
  echo "<div class='alert alert-danger alert-dismissible fade show' style='background:#003366; color:white;'>
  <button type='button' class='close' data-dismiss='alert'style='color:white;'>&times;</button>
  <strong>Sorry!</strong> No products found in this Brand!
</div>";
}
  ...
  $product_brand = $row_brand_products['product_brand'];
      $product_status = $row_brand_products['product_status'];
      
      $product_price = $row_brand_products['product_price'];
      $product_img1 = $row_brand_products['product_img1'];
      $product_img2 = $row_brand_products['product_img2'];
	...
	global $connection;
	 $get_cat = "SELECT * FROM `brands` WHERE 1";
                      $run_cats = mysqli_query($connection, $get_cat);
                       ...
                       echo"
                        <li>
                            <a href='shopee.php?brand=$brand_id'>
                               $brand_title</a>
                        </li>";
                      }  
}
