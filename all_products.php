...
<!-----4 row---->
  ...
  <div class="container-fluid"style="margin-top: 30px;border-bottom: 5px solid #003366;  ">
  <div class="row" style="margin-top: 10px;">
  <div class="col-md-12" >
     <div class="row rowcontent" style="margin-top: 0px;">
<?php $get_products = "SELECT * FROM `products`";
    ...
    echo"
            <div class='col-md-2 col-sm-3' >
                <div class='product-grid'>
                    <div class='product-image'style='border:1px solid gray;'>
                        <a href='#'>
